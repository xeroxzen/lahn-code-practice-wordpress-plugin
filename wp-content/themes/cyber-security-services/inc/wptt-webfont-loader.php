...
if ( ! class_exists( 'Cyber_Security_Services_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Cyber_Security_Services_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Cyber_Security_Services_WPTT_WebFont_Loader( $url );
